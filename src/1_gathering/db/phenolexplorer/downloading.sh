...
wget -nv "http://phenol-explorer.eu/system/downloads/current/composition-data.xlsx.zip" -O ../data/external/dbSource/phenolexplorer/composition-data.xlsx.zip
...
wget -nv "http://phenol-explorer.eu/system/downloads/current/compounds.csv.zip" -O ../data/external/dbSource/phenolexplorer/compounds.csv.zip
...
wget -nv "http://phenol-explorer.eu/system/downloads/current/compounds-structures.csv.zip" -O ../data/external/dbSource/phenolexplorer/compounds-structures.csv.zip
...
wget -nv "http://phenol-explorer.eu/system/downloads/current/foods.csv.zip" -O ../data/external/dbSource/phenolexplorer/foods.csv.zip
...
wget -nv "http://phenol-explorer.eu/system/downloads/current/publications.csv.zip" -O ../data/external/dbSource/phenolexplorer/publications.csv.zip
