...
taxo_cleaning_auto <- function(dfsel) {
  ...
  #     end = 1
  #   )) %>%
  #   group_by(organismDbTaxo,
  #            organismDetected_1,
  #            organism_1_kingdom) %>% # intraDB consistency complex (Echinacea example)
  #   add_count() %>%
  #   group_by(organismDbTaxo,
  #            organismDetected_1) %>%
  #   add_count(name = "m") %>%
  ...
  #
  # df2_a <- semi_join(dfsel,
  #                    df1_c)
  #
  # df2_b <- anti_join(dfsel,
  #                    df1_c) %>%
  #   distinct(organismOriginal,
  #            organismDbTaxo,
  #            organismDetected)
  #
  # df2_c <- df2_b %>%
  #   distinct(organismDbTaxo,
  #            organismDetected)
  #
  # df3_a <- left_join(df2_c,
  #                    df1_c) %>%
  ...
  ## old step before gnverify, we can now drop it IMO
  # df4 <- df3_c
