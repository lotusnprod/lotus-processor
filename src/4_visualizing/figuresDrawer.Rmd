...
top_organism_gentianaceae <- top_organism_gentianaceae$organismCleaned_dbTaxo_7species
...
top_chemo_gentianaceae <- top_chemo_gentianaceae$structureCleanedInchikey3D
```
