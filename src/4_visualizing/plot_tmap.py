...
cmap3 = mcolors.ListedColormap(
    ["lightgray", "lightgray", "lightgray", "lightgray", "lightgray", "lightgray", "lightgray", "firebrick"])
...
lf = tm.LSHForest(1024, 64)
lf.restore(
    "210312_lotus_db.dat")  # Version "210312_lotus_db.dat" contains 270'336 resulting from 210223_frozen_metadata groupby(structure_wikidata)
...
x, y, s, t = pickle.load(open("coords_210312_lotus_db.dat",
...
f.add_scatter(
    ...
    colormap=["tab20", "tab20", "tab20", "tab20", "tab20", "tab20", "tab20", "tab20", "tab20", "tab20", "tab20",
              "tab20", "tab20", "tab20", cmap, cmap2, cmap, cmap, cmap, cmap, cmap, cmap, cmap3,
