...
t = list(t)
pickle.dump(
    (x, y, s, t), open("../data/interim/tmap/230106_coords_lotus_2D_map4.dat", "wb+"), protocol=pickle.HIGHEST_PROTOCOL
)
...
x, y, s, t = pickle.load(open("../data/interim/tmap/230106_coords_lotus_2D_map4.dat",
                              "rb"))
