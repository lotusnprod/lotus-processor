for file in ../data/interim/tables_min/1_translated/gnfinder/*.tsv
...
do
	...
	cat $file | gnfinder find -c -l detect -s $(seq -s, 1 1 182 | sed s/,\$//) -t "0" > ../data/interim/tables_min/2_cleaned/gnfinder/translated/json/$filename.json
