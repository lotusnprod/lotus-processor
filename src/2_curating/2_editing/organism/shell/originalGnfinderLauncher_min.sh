for file in ../data/interim/tables_min/0_original/organism/*.tsv; do
  ...
  gnfinder find -c -l detect -s 3,4,5,6,8,9,11,12,118,128,132,147,148,150,155,158,163,164,165,167,169,174,175,180,187 -t "0" <$file >../data/interim/tables_min/2_cleaned/organism/original/$filename.json
