...
REMOVE_FRAGMENTS = (
    ...
    FragmentPattern(
        "perchlorate related ion", "[#8]-[Cl+3](-[#8-])(-[#8-])-[#8-]"
    ),  # added pma
    ...
    # added pma
    FragmentPattern(
        "3-Methyl-4-nitro-1-(4-nitrophenyl)-1H-pyrazol-5-ol ion",
        "[#6]-c1nn(c(c1-[#7+](-[#8-])=[#8])-[#8])-c2ccc(cc2)-[#7+](-[#8-])=[#8]",
    ),  # added pma
    FragmentPattern(
        "picric acid",
        "c1c(cc(c(c1-[#7+](=[#8])-[#8-])-[#8])-[#7+](=[#8])-[#8-])-[#7+](=[#8])-[#8-]",
    ),  # added pma
)
...
class FragmentRemover(object):
    ...
    def __init__(self, fragments=REMOVE_FRAGMENTS, leave_last=LEAVE_LAST):
        ...
        ----------
        fragments : Any
            REMOVE_FRAGMENTS. Default is REMOVE_FRAGMENTS.
        leave_last : Any
            LEAVE_LAST. Default is LEAVE_LAST.
        """
...
class LargestFragmentChooser(object):
    ...
    def __init__(self, prefer_organic=PREFER_ORGANIC):
        ...
        ----------
        prefer_organic : Any
            PREFER_ORGANIC. Default is PREFER_ORGANIC.
        """
