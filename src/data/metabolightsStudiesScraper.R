...
data <- xmlParse("0_initial_files/eb-eye_metabolights_studies.xml")
...
url <- 'https://www.ebi.ac.uk/metabolights/webservice/beta/compound/'
...
getmetabolights <- function(X)
{
  tryCatch({
    ...
    destfile = paste("0_initial_files/scraped_studies/", cd_id, ".json", sep = "")
