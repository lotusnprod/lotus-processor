...
echo " create if not exist table taxa_otl(uid int, parent_uid int, name text, rank text, sourceinfo text, uniqname text, flags text);"
echo " .separator \"\\t\""
echo " .import taxonomy.tsv taxa_otl"
